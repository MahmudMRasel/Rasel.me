  ...
  return (
    <section id="hire-me" className="container mx-auto px-6 py-16 relative overflow-hidden">
      ...
      <div className="text-center mb-12">
        ...
        >
          <span className="bg-gradient-to-r from-blue-600 via-blue-500 to-teal-500 bg-clip-text text-transparent">Let's Work Together</span>
        </h2>
        <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-teal-500 mx-auto rounded-full"></div>
        <p className="text-gray-600 text-lg mt-4">Where data, development, and design intersect</p>
      </div>
      ...
      >
        <div className="space-y-8">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center max-w-3xl mx-auto">
            I'm open to roles in Data Analytics, Frontend Development, or UX Research—especially where these areas overlap. If you think I could be a good fit for your team, I'd love to connect.
          </p>

          {/* Contact Options */}
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-center bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Connect With Me</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              ...
              >
                ...
                <span className="font-medium text-gray-800">Download CV</span>
              </a>
              ...
              >
                ...
                <span className="font-medium text-gray-800">Write Me</span>
              </a>
            </div>
          </div>
        </div>
