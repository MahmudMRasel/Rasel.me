  ...
  const skillGroups = [
    {
      ...
      skills: ["Power BI (DAX, Power Query)", "SQL", "Excel", "KPI Dashboards", "Reporting"]
    },
    {
      ...
      skills: ["Python", "Pandas", "NumPy", "Jupyter", "EDA", "Data Cleaning", "Matplotlib", "Seaborn", "Plotly"]
    },
    {
      ...
      skills: ["scikit-learn", "XGBoost", "Classification", "Feature Engineering", "Tree Models (Decision Trees, Random Forest)"]
    },
    {
      title: "Frontend",
      icon: (
    ...
    },
    {
      ...
      skills: ["Figma", "User Research", "Usability Testing", "Heuristic Evaluation"]
    },
    {
      ...
      skills: ["Git", "Netlify", "PM4Py", "NetworkX", "spaCy"]
    }
  ]
  ...
  return (
    <section id="skills" className="container mx-auto px-6 py-16">
      <div className="text-center mb-16">
        ...
        >
          <span className="bg-gradient-to-r from-blue-600 via-blue-500 to-teal-500 bg-clip-text text-transparent">Skills & Expertise</span>
        </h2>
        <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-teal-500 mx-auto rounded-full"></div>
        <p className="text-gray-600 mt-4 text-lg">Tools I work with</p>
      </div>
